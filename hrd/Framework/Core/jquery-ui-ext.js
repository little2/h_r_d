	...
	$.widget('ui.multiAccordion', {
		...
		_create : function() {
			...
			$h3.each(function(index) {
				var $this = $(this);
				$this.addClass(options._classes.h3).prepend(
						'<span class="{class}"></span>'.replace(/{class}/, options._classes.span));
		...
		destroy : function() {
			...
			$h3.removeClass(options._classes.h3).removeClass(
					'ui-state-default ui-corner-all ui-state-active ui-corner-top').children('span').remove();
		...
		// active option passed by plugin, this method will read it and convert
		// it into array of tab indexes
