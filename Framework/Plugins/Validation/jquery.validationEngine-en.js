	...
	$.validationEngineLanguage = {
		newLang : function() {
			$.validationEngineLanguage.allRules = {
				...
				// 以下是自定义的校验器，你可以根据需要修改或是移除他们
				"ajaxI18nCode" : {
					"url" : "sys/sysI18nC/isRepeat.html",
					// 扩展查询：除本身需要提交的input以外的input，注意，皆通过ID进行提交
					"extraIds" : "languageType",
					// 如果后台响应的json中含有status对象并且为false，同时后台响应的json中未提供msg对象，则显示此值
